 ...
 * looking up a {@link CalendarUser} and converting it into a
 * {@link UserDetails} so that Spring Security can do the username/password
 * comparison for us.
 * 
 * @author Rob Winch
 * 
...
public class CalendarUserDetailsService implements UserDetailsService {
    ...
    /**
     * Lookup a {@link CalendarUser} by the username representing the email
     * address. Then, convert the {@link CalendarUser} into a
     * {@link UserDetails} to conform to the {@link UserDetails} interface.
     */
    @Override
